...
public class DrinkFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button = (Button) mView.findViewById(R.id.generatebtn);
        advice = (TextView) mView.findViewById(R.id.suggestedwater);

        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                response = (EditText) mView.findViewById(R.id.editTextNumber);
                String value= response.getText().toString();
                number = Double.parseDouble(value);
                double half = (number / 2);
                advice.setText("You should drink between " + half + "and" + number + "oz of water a day to stay hydrated.");
            }
        });
